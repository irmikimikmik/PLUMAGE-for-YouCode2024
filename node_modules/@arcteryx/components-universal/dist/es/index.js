...
const Script = _ref => {
  ...
  let component = url && (!injectInHead || WrapComponent) ? /*#__PURE__*/React.createElement("script", {
    src: url,
    async: async,
    defer: defer
  }) : null;
  if (component && WrapComponent) {
    component = /*#__PURE__*/React.createElement(WrapComponent, null, component);
  }
  return component;
};
...
const TagManagerScript = _ref => {
  ...
  return !disableAdobeLaunch ? /*#__PURE__*/React.createElement(Script, _extends({
    url: url
  }, props)) : null;
};
...
const UIComponentsScript = _ref => {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Script, _extends({
    url: headerUrl
  }, props)), loadFooter ? /*#__PURE__*/React.createElement(Script, _extends({
    url: footerUrl,
    async: false,
    defer: true
  }, props)) : null, market !== "leaf" ? /*#__PURE__*/React.createElement(Script, _extends({
...
const HeaderFragment = _ref => {
  ...
  const header = /*#__PURE__*/React.createElement(`arcteryx-${market}-header`, {
    class: className,
    market,
    country,
    language,
  ...
  const localeSwitcher = /*#__PURE__*/React.createElement("arcteryx-locale-switcher", {
    country,
    language
  });
  return /*#__PURE__*/React.createElement(React.Fragment, null, loadScript && /*#__PURE__*/React.createElement(UIComponentsScript, {
    uiBaseUrl: uiBaseUrl,
    env: env,
...
const UIFooterElement = _ref => {
  ...
  return /*#__PURE__*/React.createElement(`arcteryx-${market}-footer`, {
    country,
    language,
    id: "arcteryx-footer"
  });
...
const UIFooter = _ref2 => {
  ...
  const footerUrl = `${uiBaseUrl}/${country}/${language}/${scriptPrefix}${market}Footer.js`;
  return /*#__PURE__*/React.createElement(React.Fragment, null, loadScript ? /*#__PURE__*/React.createElement(Script, _extends({
    url: footerUrl,
    async: false,
    defer: true
  }, props)) : null, /*#__PURE__*/React.createElement(UIFooterElement, {
    market: market,
    country: country,
    language: language
  }));
...
const LazyUIFooter = _ref => {
  ...
  return /*#__PURE__*/React.createElement(FooterWrapperDiv, {
    ref: ref,
    className: "qa--footer",
  ...
  }, isOnScreen ? /*#__PURE__*/React.createElement(UIFooter, {
    uiBaseUrl: uiBaseUrl,
    scriptPrefix: scriptPrefix,
    loadScript: true,
    env: deployEnv
...
const HeaderFooterLayout = _ref => {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(UIHeader, _extends({
    uiBaseUrl: uiBaseUrl,
    scriptPrefix: scriptPrefix,
    env: deployEnv,
    loadFooter: false
  }, headerProps)), children, /*#__PURE__*/React.createElement(LazyUIFooter, _extends({
    uiBaseUrl: uiBaseUrl,
    scriptPrefix: scriptPrefix,
    deployEnv: deployEnv
  }, footerProps)));
...
export { COOKIE_SCRIPT_PREFIX_KEY, HeaderFooterLayout, LazyUIFooter, TagManagerScript, UIComponentsScript, UIFooter, UIHeader, UI_LAZY_FOOTER_DEFAULT_ROOT_MARGIN, config };
