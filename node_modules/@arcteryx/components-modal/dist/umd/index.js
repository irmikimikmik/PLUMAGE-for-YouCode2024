(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-dom'), require('prop-types'), require('styled-components'), require('@arcteryx/components-typography'), require('react-swipeable')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-dom', 'prop-types', 'styled-components', '@arcteryx/components-typography', 'react-swipeable'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, (function () {
    var current = global.ARCTERYX && global.ARCTERYX.componentsmodal;
    var exports = (global.ARCTERYX = global.ARCTERYX || {}, global.ARCTERYX.componentsmodal = {});
    factory(exports, global.React, global.ReactDOM, global.PropTypes, global.styled, global.componentsTypography, global.reactSwipeable);
    exports.noConflict = function () { global.ARCTERYX.componentsmodal = current; return exports; };
  })());
})(this, (function (exports, React, ReactDOM, PropTypes, styled, componentsTypography, reactSwipeable) { 'use strict';
...
`;
  function Modal(_ref) {
    ...
    }, /*#__PURE__*/React__default["default"].createElement(ModalUI, _extends({
  ...
  const InfoIconWrapper = styled__default["default"].div`
  display: flex;
...
`;
  const InfoIcon = styled__default["default"].span`
...
`;
  ...
  **/
  const InfoIconModal = _ref => {
    ...
    if (modalUrl) {
      return /*#__PURE__*/React__default["default"].createElement(InfoIconWrapper, {
        justify: justify
      }, labelText ? /*#__PURE__*/React__default["default"].createElement(componentsTypography.P, null, labelText) : null, /*#__PURE__*/React__default["default"].createElement(InfoIcon, {
        onClick: callModal,
  ...
  exports.InfoIconModal = InfoIconModal;
  exports.Modal = Modal;
