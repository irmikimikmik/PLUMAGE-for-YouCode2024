import React, { useState, useRef, useEffect, forwardRef, useCallback, useMemo, Fragment } from 'react';
import PropTypes from 'prop-types';
import { useDropzone } from 'react-dropzone';
import styled, { css } from 'styled-components';
import { Breakpoint, ScreenSize, P } from '@arcteryx/components-typography';
import { useTranslation } from 'react-i18next';
import { parsePhoneNumberFromString } from 'libphonenumber-js';
import IMask from 'imask';
import { usePlacesWidget } from 'react-google-autocomplete';
import { FormInputField as FormInputField$1 } from '@arcteryx/components-form';
...
`;
const RequiredSpan$1 = styled.span`
  color: var(--warning-red);
  font-size: 14px;
  line-height: 1;
  margin: 0;
...
const useDetectMobile = () => {
  ...
  return width !== null && width <= (ScreenSize === null || ScreenSize === void 0 ? void 0 : ScreenSize.lg); // 992
};
...
const TooltipWrapper = styled.span`
  ...
  display: grid;
`;
const TooltipTipImg = styled.img`
  height: 50px;
  width: 150px;
  position: relative;
  display: inline-block;
...
const Tooltip = _ref => {
  ...
  }, /*#__PURE__*/React.createElement(TooltipWrapper, null, imgURL && /*#__PURE__*/React.createElement(TooltipTipImg, {
    src: `${imgURL}`,
    "data-testid": "tooltip-img",
    alt: "arcteryx"
  }), subHeader && /*#__PURE__*/React.createElement(SubHeader, {
    "data-testid": "tooltip-subHeader"
  }, subHeader), /*#__PURE__*/React.createElement(Content, null, title)))));
};
Tooltip.propTypes = {
...
const Label$4 = _ref => {
  ...
  return /*#__PURE__*/React.createElement(LabelStyled, {
    className: "qa-control-label",
    id: `labelFor--${name}`,
    htmlFor: name
  }, required && /*#__PURE__*/React.createElement(RequiredSpan, null, "*"), labelText, attachColon && ":");
};
...
const LabelHeaderField = _ref => {
  ...
  return /*#__PURE__*/React.createElement("div", null, label && /*#__PURE__*/React.createElement(Label$4, {
    htmlFor: id,
    name: id,
    labelText: label,
...
const RejectionMessage = styled.div`
  color: var(--warning-red);
`;
const FileUpload = /*#__PURE__*/forwardRef((_ref, ref) => {
  let {
      register,
      setValue,
      error,
  ...
  const {
    t
  } = useTranslation("components-form");
  ...
  const acceptedFileItems = acceptedFiles.map(file => /*#__PURE__*/React.createElement("div", {
    key: file.name
  }, file.name));
  const fileRejectionsItems = fileRejections.map(_ref2 => {
    ...
    return /*#__PURE__*/React.createElement(RejectionMessage, {
      key: file.name
    }, rejectionErrorMessages[errors[0].code] || generalUploadErrorMessage, " ", file.name);
  });
  const style = useMemo(() => _objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({}, baseStyle), isDragActive ? activeStyle : {}), isDragAccept ? acceptStyle : {}), isDragReject ? rejectStyle : {}), [isDragActive, isDragReject, isDragAccept]);
  useEffect(() => {
  ...
  return /*#__PURE__*/React.createElement(FormRow, {
  ...
  }, /*#__PURE__*/React.createElement(LabelHeaderField, {
    id: id,
    label: label,
    required: required,
    error: error,
  ...
  }, /*#__PURE__*/React.createElement(SectionField, getRootProps({
    isDragActive,
    isDragAccept,
    isDragReject,
    style
  }), /*#__PURE__*/React.createElement(FormP, null, /*#__PURE__*/React.createElement(SpanLeft, null, fileHeaderPart1), /*#__PURE__*/React.createElement(SpanLink, null, fileHeaderPart2), /*#__PURE__*/React.createElement(SpanRight, null, fileHeaderPart3)), /*#__PURE__*/React.createElement("input", _extends({}, register(name, {
    ...
    "data-testid": id
  })), /*#__PURE__*/React.createElement(Aside, null, acceptedFiles.length <= acceptedFiles && !fileRejections.length ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(FormP, null, displayMessage)) : null, acceptedFiles.length >= acceptedFile ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(FormP, null, acceptedFileItems)) : null, fileRejections.length ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(FormP, null, fileRejectionsItems)) : null), /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(FormP, null, validExtensionMessage), /*#__PURE__*/React.createElement(FormP, null, maxSizeMessage)))));
});
...
const Checkbox$1 = _ref => {
  ...
  return /*#__PURE__*/React.createElement(FormRowCheckbox, {
    className: `${className ? className : ""}`,
    isCheckbox: true
  }, /*#__PURE__*/React.createElement(FormInputCheckbox, {
    isCheckbox: true
    ...
    disabled: disabled
  }, inputProps || {})), /*#__PURE__*/React.createElement(Label$3, {
    id: `labelFor--${name}`,
    htmlFor: name,
    disabled: disabled
...
`;
const Radio$1 = styled.input.attrs({
  type: "radio"
})`
  position: absolute;
  opacity: 0;
  ...
  ${props => props.checked && css`
    ...
    `};
  ${props => props.disabled && props.checked && css`
      & + ${Toggle$1}:before {
        border: 1px solid var(--inactive-state-grey);
      }
      & + ${Toggle$1}:after {
...
const RadioVariant = props => {
  ...
  }), /*#__PURE__*/React.createElement(Toggle$1, null, /*#__PURE__*/React.createElement("span", null, props.labelText)))));
};
...
const RadioButton = /*#__PURE__*/React.forwardRef((props, ref) => {
  ...
  return /*#__PURE__*/React.createElement(FormRow, {
    ...
    checked: props.checked,
    onClick: onClickHandler
  }), /*#__PURE__*/React.createElement(Toggle, null, /*#__PURE__*/React.createElement("span", null, props.labelText)))));
});
...
const FormInputField = /*#__PURE__*/forwardRef((_ref, ref) => {
...
const FormSelectField = /*#__PURE__*/forwardRef((_ref, ref) => {
  let {
      error,
      label,
      id,
  ...
  return /*#__PURE__*/React.createElement(FormRow, {
    ...
    onChange: onChange
  }), disallowEmptyOption ? null : placeHolderText ? /*#__PURE__*/React.createElement("option", {
    id: "input-place-holder",
    disabled: true,
    value: ""
  }, placeHolderText) : /*#__PURE__*/React.createElement("option", {
    defaultValue: true
  }), list === null || list === void 0 ? void 0 : list.map((item, idx) => /*#__PURE__*/React.createElement("option", {
    key: `${item.value}-${idx}`,
    value: item.value
  }, item.label)))));
});
...
const FormTextareaField = /*#__PURE__*/forwardRef((_ref, ref) => {
  let {
      error,
      label,
      id,
  ...
  }, inputProps.name && label && /*#__PURE__*/React.createElement(LabelHeaderField, {
    id: id,
    label: label,
    required: required,
    error: error,
...
const ToggleButton = /*#__PURE__*/forwardRef((_ref, ref) => {
  ...
  return /*#__PURE__*/React.createElement(ToggleButtonWrap, {
    className: className
    ...
    onBlur: onBlur,
    checked: checked
  }), /*#__PURE__*/React.createElement(ToggleUI, null));
});
...
const LabelWrap = styled.div`
  ...
  display: flex;
`;
const FormToggleButton = /*#__PURE__*/forwardRef((_ref, ref) => {
  let {
      name,
      disabled,
      required,
  ...
  return /*#__PURE__*/React.createElement(FormRow, {
    ...
    isCheckbox: true
  }, /*#__PURE__*/React.createElement(CheckFormInput, null, toolTip && /*#__PURE__*/React.createElement(Tooltip, {
    title: toolTip,
    isCheckbox: true
    ...
    name: name,
    disabled: disabled
  }, toggleProps)), /*#__PURE__*/React.createElement(LabelWrap, null, /*#__PURE__*/React.createElement(Label, {
    htmlFor: toggleId,
    disabled: disabled
  }, required && /*#__PURE__*/React.createElement(RequiredSpan$1, null, "*"), /*#__PURE__*/React.createElement(SpanToggle, null, children, " ", renderAfterLabel, " ", formLink && /*#__PURE__*/React.createElement("a", {
    href: formLink.link,
    target: "_blank"
  }, formLink.label)), error && /*#__PURE__*/React.createElement(ErrorTextCheckForm, {
...
const createPostalCodeMask = country => country && maskDictionary[country.toUpperCase()] ? IMask.createMask({
...
const createPhoneNumberMask = country => IMask.createMask({
...
const PasswordStrengthIndicator = props => /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(Message, {
  id: "passwordStrength"
}, /*#__PURE__*/React.createElement(MessageDetail, props)));
const MessageDetail = props => {
  const data = props.passwordValidationMessage;
  const messageValidation = /*#__PURE__*/React.createElement(React.Fragment, null, data.map(list => /*#__PURE__*/React.createElement("li", {
    key: list.id,
    id: list.title,
    className: `${validationError}`
  }, list.content)));
  return /*#__PURE__*/React.createElement(React.Fragment, null, messageValidation);
};
...
const IsPoBox = _ref => {
  ...
  return !getIsEMEA(currentCountry) && /*#__PURE__*/React.createElement(FormToggleButton, _extends({
    name: "1"
  }, register("isPoBox"), {
    error: isPoBox
...
const PhoneNumber = _ref2 => {
  ...
  return /*#__PURE__*/React.createElement(FormInputField, _extends({
    id: inputName,
    type: "tel",
...
const CountryProvince = _ref4 => {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(FormSelectField, _extends({
    id: countryName
  ...
  })), countryNotice, shouldShowProvince && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(FormSelectField, _extends({
  ...
  })), /*#__PURE__*/React.createElement("input", _extends({}, register("regionId"), {
    type: "hidden"
  }))));
};
...
const BaseAddressInputs = _ref => {
  ...
  return /*#__PURE__*/React.createElement(Fragment, null, !hideName && /*#__PURE__*/React.createElement(FormInputField, _extends({
    id: "firstName",
    ...
    error: firstName
  })), !hideName && /*#__PURE__*/React.createElement(FormInputField, _extends({
    id: "lastName",
    ...
    error: lastName
  })), /*#__PURE__*/React.createElement(FormInputField, _extends({
  ...
  })), /*#__PURE__*/React.createElement(FormInputField, _extends({}, register("address2", {}), {
    label: t("Address 2"),
    error: address2,
    type: "text",
    valid: currentAddress2,
    placeholder: showRegion ? t("Apt, suite, PO Box, etc. (optional)") : t("Apt, suite etc. (optional)")
  })), /*#__PURE__*/React.createElement(FormInputField, _extends({}, register("city", {
  ...
  })), /*#__PURE__*/React.createElement(CountryProvince, {
    register: register,
    errors: {
      country,
      province
  ...
  }), /*#__PURE__*/React.createElement(PostalCode, {
    register: register,
    errors: {
      postalCode
    },
...
const EmailInput = _ref => {
  ...
  return /*#__PURE__*/React.createElement(FormInputField$1, _extends({
    id: id,
    type: "email",
    name: name,
...
export { BaseAddressInputs, Checkbox$1 as CheckboxVariant, CountryProvince, EmailInput, FileUpload, FormInputField, FormSelectField, FormTextareaField, FormToggleButton, IsPoBox, LabelHeaderField, PasswordStrengthIndicator, PhoneNumber, PostalCode, RadioButton, RadioVariant, Tooltip, ValidatePassword, getIsEMEA, resources_DONOTEDIT as i18nResources, isPostalCode, normalizedPhoneNumber, normalizedPostalCode };
