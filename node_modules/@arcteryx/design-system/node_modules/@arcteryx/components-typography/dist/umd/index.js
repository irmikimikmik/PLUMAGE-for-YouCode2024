(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('styled-components'), require('react'), require('styled-components-breakpoint')) :
  typeof define === 'function' && define.amd ? define(['exports', 'styled-components', 'react', 'styled-components-breakpoint'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, (function () {
    ...
    factory(exports, global.styled, global.React, global.styledComponentsBreakpoint);
    exports.noConflict = function () { global.ARCTERYX.componentstypography = current; return exports; };
  })());
})(this, (function (exports, styled, React, styledComponentsBreakpoint) { 'use strict';
...
`;
  ...
  const Blockquote = props => /*#__PURE__*/React__default["default"].createElement(Quote, props, "\"", props.children, "\"");

  const Note = styled__default["default"].p`
  max-width: none;
`;
  const List = styled__default["default"].ul`
max-width: none;
`;
  const CubeWrap = styled__default["default"].div`
  display: flex;
  justify-content: center;
  align-items: center;
  height: 100vh;
`;
  const Cubes = styled__default["default"].div`
  display: flex;
  justify-content: center;
...
`;
  const CubeYellow = styled__default["default"](Cube)`
  width: var(--space-xs);
  height: var(--space-xs);
  background-color: #EBCC83;
`;
  const CubeBlue = styled__default["default"](Cube)`
  width: var(--space-s);
  height: var(--space-s);
  background-color: #A0E6EB;
`;
  const CubeGreen = styled__default["default"](Cube)`
  width: var(--space-m);
  height: var(--space-m);
  background-color: #C8EBA0;
`;
  const CubePurple = styled__default["default"](Cube)`
  width: var(--space-l);
  height: var(--space-l);
  background-color: #A0AFEB;
`;
  const CubePink = styled__default["default"](Cube)`
  width: var(--space-xl);
  height: var(--space-xl);
  background-color: #DBABE9;
`;
  const CubeRed = styled__default["default"](Cube)`
  width: var(--space-xxl);
...
`;
  ...
  margin-right: 5px;  
`;
  const SquareYellow = styled__default["default"](Square)`
  background-color: #EBCC83;
`;
  const SquareBlue = styled__default["default"](Square)`
  background-color: #A0E6EB;
`;
  const SquareGreen = styled__default["default"](Square)`
  background-color: #C8EBA0;
`;
  const SquarePurple = styled__default["default"](Square)`
  background-color: #A0AFEB;
`;
  const SquarePink = styled__default["default"](Square)`
  background-color: #DBABE9;
`;
  const SquareRed = styled__default["default"](Square)`
  background-color: #EB9595;
`;
  const Spacing = () => /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(Note, null, "Arc\u2019teryx layouts often employ active white space, or what we prefer to call \"considered white space\", inferring that it has been designed into the layout with conscious effort."), /*#__PURE__*/React__default["default"].createElement(Note, null, "Elements on a webpage require white space to physically and conceptually separate them from the elements that come before and after them."), /*#__PURE__*/React__default["default"].createElement(Note, null, "We measure our spacing by setting a default value of 1em equal to 15 pixels."), /*#__PURE__*/React__default["default"].createElement(Note, null, "As the viewport grows smaller or larger our vertical spacing rules will also respond proportionally."), /*#__PURE__*/React__default["default"].createElement(CubeWrap, null, /*#__PURE__*/React__default["default"].createElement(Cubes, null, /*#__PURE__*/React__default["default"].createElement(CubeYellow, {
    title: "XS"
  }), /*#__PURE__*/React__default["default"].createElement(CubeBlue, {
    title: "S"
  }), /*#__PURE__*/React__default["default"].createElement(CubeGreen, {
    title: "M"
  }), /*#__PURE__*/React__default["default"].createElement(CubePurple, {
    title: "L"
  }), /*#__PURE__*/React__default["default"].createElement(CubePink, {
    title: "XL"
  }), /*#__PURE__*/React__default["default"].createElement(CubeRed, {
    title: "XXL"
  }))), /*#__PURE__*/React__default["default"].createElement("p", null, "Figma ", /*#__PURE__*/React__default["default"].createElement("a", {
    href: "https://www.figma.com/file/xiTC7i82LbrfGrMQRqsxLY/Arc'teryx-Components?node-id=229%3A5039&mode=dev"
  }, "reference")), /*#__PURE__*/React__default["default"].createElement("br", null), /*#__PURE__*/React__default["default"].createElement(List, null, /*#__PURE__*/React__default["default"].createElement("li", null, /*#__PURE__*/React__default["default"].createElement(SquareYellow, null), "var(--space-xs): Yellow spacing is used on certain form elements."), /*#__PURE__*/React__default["default"].createElement("li", null, /*#__PURE__*/React__default["default"].createElement(SquareBlue, null), "var(--space-s): Base value."), /*#__PURE__*/React__default["default"].createElement("li", null, /*#__PURE__*/React__default["default"].createElement(SquareGreen, null), "var(--space-m): Green spacing creates space between standalone elements on a webpage. Green spacing separates tertiary elements within a (pink) section."), /*#__PURE__*/React__default["default"].createElement("li", null, /*#__PURE__*/React__default["default"].createElement(SquarePurple, null), "var(--space-l): Purple spacing separates the header/breadcrumb. Purple spacing separates seconday elements within a (pink) section."), /*#__PURE__*/React__default["default"].createElement("li", null, /*#__PURE__*/React__default["default"].createElement(SquarePink, null), "var(--space-xl): Pink spacing separates and creates unique sections on a webpage."), /*#__PURE__*/React__default["default"].createElement("li", null, /*#__PURE__*/React__default["default"].createElement(SquareRed, null), "var(--space-xxl): Red spacing separates the page bottom of the page content from the bird signature and/or footer.")));
