 ...
 */
export interface CustomPortableTextBlock extends Omit<PortableTextBlock, "_type"> {
    _type: "block";
}
...
export type RichTextBlocks = Array<PortableTextButton | PortableTextPhone | PortableTable | CustomPortableTextBlock | PortableImageContainer>;
