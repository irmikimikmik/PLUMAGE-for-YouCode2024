(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('styled-components'), require('react-imgix'), require('react-dom'), require('prop-types'), require('styled-components-breakpoint'), require('react-swipeable'), require('classnames'), require('lazysizes'), require('lazysizes/plugins/parent-fit/ls.parent-fit'), require('lazysizes/plugins/attrchange/ls.attrchange')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'styled-components', 'react-imgix', 'react-dom', 'prop-types', 'styled-components-breakpoint', 'react-swipeable', 'classnames', 'lazysizes', 'lazysizes/plugins/parent-fit/ls.parent-fit', 'lazysizes/plugins/attrchange/ls.attrchange'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, (function () {
    var current = global.ARCTERYX && global.ARCTERYX.componentscontentblocks;
    var exports = (global.ARCTERYX = global.ARCTERYX || {}, global.ARCTERYX.componentscontentblocks = {});
    factory(exports, global.React, global.styled, global.Imgix, global.ReactDOM, global.PropTypes, global.styledComponentsBreakpoint, global.reactSwipeable, global.cx);
    exports.noConflict = function () { global.ARCTERYX.componentscontentblocks = current; return exports; };
  })());
})(this, (function (exports, React, styled, Imgix, ReactDOM, PropTypes, styledComponentsBreakpoint, reactSwipeable, cx) { 'use strict';

  function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

  var React__default = /*#__PURE__*/_interopDefaultLegacy(React);
  var styled__default = /*#__PURE__*/_interopDefaultLegacy(styled);
  var Imgix__default = /*#__PURE__*/_interopDefaultLegacy(Imgix);
  ...
  const StyledImage = styled__default["default"](Imgix__default["default"])`
  object-fit: cover;
...
`;
  ...
  /** Mobile - 375 */
  const baseMarginStyles = styled.css`
  margin-top: ${_ref => {
  let {
...
`;
  /** Tablet - 768 */
  const tabletMarginStyles = styled.css`
...
`;
  /** Desktop - 1440 */
  const desktopMarginStyles = styled.css`
...
`;
  /** Mobile - 375 */
  const baseFontStyles = styled.css`
  color: ${_ref5 => {
  let {
    color = "#ffffff"
  } = _ref5;
...
`;
  ...
  /** Tablet - 375 */
  const tabletFontStyles = styled.css`
...
`;
  ...
  /** Desktop - 1440 */
  const desktopFontStyles = styled.css`
...
`;
  ...
  /** Tablet - 768*/
  const tabletFlexBox = styled.css`
...
`;
  ...
  /** Desktop - 1440*/
  const desktopFlexBox = styled.css`
...
`;
  ...
  /** Mobile - 375 */
  const baseSizeStyles = styled.css`
  height: ${_ref18 => {
  let {
    height = "auto"
  } = _ref18;
...
`;
  ...
  /** Tablet - 768*/
  const tabletSizeStyles = styled.css`
  ${_ref22 => {
  let {
    tabletStyles
  } = _ref22;
  return tabletStyles && styled.css`
...
`;
  ...
  /** Desktop - 1440*/
  const desktopSizeStyles = styled.css`
  ${_ref23 => {
  let {
    desktopStyles
  } = _ref23;
  return desktopStyles && styled.css`
...
`;
  const fadeAnimation = styled.css`
...
`;
  const scaleAnimation = styled.css`
...
`;
  const slideUpAnimation = styled.css`
...
`;
  ...
  `}
`;
  const ModalUI = styled__default["default"].div`
  display: flex;
  flex-flow: row wrap;
  align-items: flex-end;
  justify-content: center;
...
`;
  const ModalBox = styled__default["default"].div`
  width: 100%;
  position: relative;
...
`;
  function Modal(_ref) {
    ...
    return modalIsShown ? /*#__PURE__*/ReactDOM__default["default"].createPortal( /*#__PURE__*/React__default["default"].createElement(ModalOverlay, {
    ...
    }, /*#__PURE__*/React__default["default"].createElement(ModalUI, _extends$1({
      className: `modal__ui modal--close`
    }, swipeHandlers), /*#__PURE__*/React__default["default"].createElement(ModalContent, {
      ...
      ref: contentRef,
      closable: isClosable
    }, /*#__PURE__*/React__default["default"].createElement(ModalBox, null, children)), isClosable && /*#__PURE__*/React__default["default"].createElement(ModalClose, {
  ...
  Modal.propTypes = {
    modalIsShown: PropTypes__default["default"].bool.isRequired,
    toggleModal: PropTypes__default["default"].func.isRequired,
    video: PropTypes__default["default"].bool,
    iframe: PropTypes__default["default"].bool,
    contentHeight: PropTypes__default["default"].number,
    contentMaxHeightMobile: PropTypes__default["default"].number,
    contentMaxHeight: PropTypes__default["default"].number,
    modalWidth: PropTypes__default["default"].number,
    isClosable: PropTypes__default["default"].bool,
    onVideoPlaybackEnded: PropTypes__default["default"].func,
    preventMobileOverflow: PropTypes__default["default"].bool
  };
  styled__default["default"].div`
  display: flex;
...
`;
  ({
    modalUrl: PropTypes__default["default"].string.isRequired
  });
...
`;
  ...
  ${props => (props === null || props === void 0 ? void 0 : props.adornment) && styled.css`
      &::before {
...
`;
  ...
  const ButtonVideo = _ref => {
    ...
    return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(YoutubeVideoModal, {
      youTubeID: youTubeID,
      isModalVisible: isModalVisible,
      modalCaller: modalCaller,
      setIsModalVisible: setIsModalVisible
    }), /*#__PURE__*/React__default["default"].createElement(CMSButton, {
      adornment: adornment,
      backgroundColor: backgroundColor,
      color: color,
      desktopStyles: desktopStyles,
  ...
  const ButtonList = _ref => {
    ...
    return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, buttons.map(_ref2 => {
      let {
          type,
          label,
          onClick = () => null,
      ...
      if (type === "buttonYoutube") {
        ...
        return /*#__PURE__*/React__default["default"].createElement(ButtonVideo, {
          adornment: adornment,
      ...
      return /*#__PURE__*/React__default["default"].createElement(CMSButton, {
        adornment: adornment,
        backgroundColor: rest === null || rest === void 0 ? void 0 : rest.backgroundColor,
        color: rest === null || rest === void 0 ? void 0 : rest.color,
        desktopStyles: responsiveStyles === null || responsiveStyles === void 0 ? void 0 : responsiveStyles.desktop,
...
`;
  const ButtonGroup = _ref => {
    ...
    return /*#__PURE__*/React__default["default"].createElement(Container, _extends$2({}, buttonContainerStyles, {
      flexDirection: flexDirection,
      tabletStyles: tabletStyles,
      desktopStyles: desktopStyles
    }), /*#__PURE__*/React__default["default"].createElement(ButtonList, {
      buttons: buttons
    }));
  };
...
`;
  ...
  const StyledH1 = styled__default["default"](H1)`
  ${baseFontStyles}
  ${baseMarginStyles}
...
`;
  const Headline = _ref => {
    ...
    return /*#__PURE__*/React__default["default"].createElement(StyledH1, {
      color: color,
      tabletStyles: tabletStyles,
      desktopStyles: desktopStyles,
      fontFamily: fontFamily,
...
`;
  ...
  const ElementsContainer = _ref8 => {
    ...
    return /*#__PURE__*/React__default["default"].createElement(StyledDiv$2, {
      ...
      return /*#__PURE__*/React__default["default"].createElement(Element, _extends$2({
  ...
  Imgix.PublicConfigAPI.disableWarning("fallbackImage");
  const StyledImgix = styled__default["default"](Imgix__default["default"])`
  position: absolute;
  top: 0;
  left: 0;
  height: 100%;
...
`;
  const BackgroundImage = _ref => {
    ...
    return /*#__PURE__*/React__default["default"].createElement(Imgix.Picture, null, sources.map(_ref2 => {
      let {
        height,
        width,
        imgixParams: {
      ...
      return /*#__PURE__*/React__default["default"].createElement(Imgix.Source, {
    ...
    }), /*#__PURE__*/React__default["default"].createElement(StyledImgix, {
  ...
  const HeroBackgroundImage = _ref => {
    ...
    return /*#__PURE__*/React__default["default"].createElement(BackgroundImage, {
      src: src,
      sources: sources,
      shouldLazyLoad: false,
      sizes: "100vw",
...
`;
  const ContentContainer = _ref2 => {
    ...
    return /*#__PURE__*/React__default["default"].createElement(StyledBlock, _extends$2({}, containerStyles, {
      "data-testid": "ctaContentContainer",
      desktopStyles: containerDesktopStyles,
      tabletStyles: containerTabletStyles
    }), hasBackgroundImage && isHero && /*#__PURE__*/React__default["default"].createElement(HeroBackgroundImage, _extends$2({}, backgroundImage.imgixParams, {
      src: backgroundImage.src,
      title: backgroundImage.title
    })), hasBackgroundImage && isSecondary && /*#__PURE__*/React__default["default"].createElement(SecondaryBackgroundImage, _extends$2({}, backgroundImage.imgixParams, {
      src: backgroundImage.src,
      title: backgroundImage.title
    })), /*#__PURE__*/React__default["default"].createElement(ElementsContainer, _extends$2({}, elementsContainerStyles, {
      elements: elements,
  ...
  overflow: hidden;
`;
  const StyledVideo = styled__default["default"].video`
  position: absolute;
  width: 100%;
  height: 100%;
  object-fit: cover;
...
`;
  ...
  const VideoBackground = _ref => {
    ...
    return /*#__PURE__*/React__default["default"].createElement(StyledDiv$1, null, /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(StyledVideo, {
      autoPlay: true,
      loop: true,
      muted: true,
      playsInline: true
  ...
  const VideoBackgroundWrapper = _ref => {
    ...
    return /*#__PURE__*/React__default["default"].createElement(VideoBackground, {
  ...
  const CtaContentBlock = _ref => {
    ...
    const Block = (_backgroundMap$backgr = backgroundMap[backgroundType]) !== null && _backgroundMap$backgr !== void 0 ? _backgroundMap$backgr : /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null);
  ...
  const HeroSection = styled__default["default"].section`
  width: 100%;
  height: 90vh;
  min-height: 450px;
...
`;
  ...
  const Hero6Section = styled__default["default"].section`
  width: 100%;
  height: calc(100vh);
  display: grid;
...
`;
  ...
  const SecondarySection = styled__default["default"].section`
  display: flex;
...
`;
  ...
  const TertiarySection = styled__default["default"].section`
  display: grid;
...
`;
  const PageLayout = _ref2 => {
    ...
    return /*#__PURE__*/React__default["default"].createElement(StyledDiv, {
      backgroundColor: backgroundColor
      ...
      return SectionComponent ? /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, {
        key: layout + index
      }, /*#__PURE__*/React__default["default"].createElement(SectionComponent, {
        "data-testid": layout
      }, blocks.map((block, blockIndex) => /*#__PURE__*/React__default["default"].createElement(CtaContentBlock, _extends$2({
        type: layout,
        key: blockIndex
      }, block))))) : null;
    }));
